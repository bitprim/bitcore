...
class ChainStateProxy implements CSP.ChainStateProvider {
  ...
  getAddressTransactionsBitprim(params: CSP.GetAddressTransactionsBitprimParams) {
    return this.get(params).getAddressTransactionsBitprim(params);
  }
  ...
  getTransactionsBitprim(params: CSP.StreamTransactionsBitprimParams) {
    return this.get(params).getTransactionsBitprim(params);
  }
